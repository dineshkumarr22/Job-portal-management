  ...
  return (
    <div className="min-h-screen bg-gray-500">
      ...
      <div className='flex items-center justify-center max-sm:mx-5 mx-auto' >
        <form onSubmit={submitHandler} className='w-full sm:w-1/2 border border-black bg-green-200 rounded-md p-4 my-10'>
          ...
          <div className='my-2'>
            ...
            <Input
              ...
              name="email"
              onChange={changeEventHandler}
              placeholder="hemachandiran@gmail.com"
            />
          </div>
          <div className='my-2'>
