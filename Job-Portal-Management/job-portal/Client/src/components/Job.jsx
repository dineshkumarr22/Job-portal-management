...
const Job = ({ job }) => {
    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100 hover:bg-red-500 hover:scale-105 transition-all duration-500 h-full flex flex-col'>
